...
- **Priority:** HIGH — **blockers cleared 2026-09-01.** Remaining: 6.6.11 and 6.6.12 (papercuts) and 6.6.15 (tooling).
- **Status:** 6.6.1–6.6.5 + 6.6.14 landed 2026-09-01 — every workaround the field report had to build (script output through `user://` files, the hand-rolled SubViewport render pipeline, `get_game_state` as an error-log substitute, finding typos by eye) now has a first-class path. E2E: **212 passed / 0 failed, coverage 163/163**, green on 4.7.2 and 4.4.1.
